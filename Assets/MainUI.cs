...
public class MainUI : MonoBehaviour
{
    ...
    public void DrawTarget(Sprite cornerSprite,Bounds objectBounds, string title)
    {
        ...
        // Upper right corner  
        DrawCornerSprite(cornerSprite, new Vector2(lowerRight.x, upperLeft.y), 90f);
        // Lower right corner
        DrawCornerSprite(cornerSprite, lowerRight, 180f);
        // Lower left corner
        DrawCornerSprite(cornerSprite, new Vector2(upperLeft.x, lowerRight.y), 270f);
    ...
    void DrawCornerSprite(Sprite sprite, Vector2 position, float rotation)
    {
